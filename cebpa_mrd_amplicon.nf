...
// include { SORT_INDEX; SORT_INDEX_CONS; GROUPREADSBYUMI; ADDGROUPS; CALLMOLCONSREADS; FILTERCONSBAM; ZIPPERBAM;
...
include { DICT_GEN } from './modules/gatk/mutect2/main.nf'
